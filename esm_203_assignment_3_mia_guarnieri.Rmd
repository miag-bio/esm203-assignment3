...
**Figure 2:** The predicted change in California groundwater flow (inflow of water - outflow of water) in 10$^9$ m$^3$ for the years 2000 to 2050. Net flow (y axis) is negative due to outflow being greater than inflow. Groundwater will decrease by `r lm_change_per_year$coefficients[2]*-10` 10$^9$ m$^3$ every ten years. Data: Curmi et al. 2013.
